...
import com.hansencx.portal.tests.commontests.ApproveCancelRebillTest;
import com.hansencx.portal.tests.commontests.CreateCancelRebillTest;
...
public class CancelRebillTests extends PortalBaseTest {
    private ArrayList<String> listTransactionID = new ArrayList<String>();
    ...
    public void testCreateCancelRebill() {
        // Call Test Case "Create Cancel Rebill"
        CreateCancelRebillTest.createCancelRebillTest(importedFilePath);
        createdTime = CreateCancelRebillTest.getCreatedTime();
        listTransactionID = CreateCancelRebillTest.getListTransactionID();
...
//        Page.ServiceCenterHistoryDetails().verifyTheTransactionIDIsCorrect(listTransactionID);
        ...
        //Call Test Case: "Approve Cancel Rebill Test"
        ApproveCancelRebillTest.approveCancelRebillTest(createdTime, listTransactionID);
